...
from ngehtsim_weather_builder.legacy import LegacyFormatError, read_legacy_partition
...
def _write_partition(directory, component_count=2, native_count=8):
    directory.mkdir()

    for suffix, with_time, count in (("_alltimes", True, native_count), ("", False, 1)):
